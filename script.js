...
const STEPS = [
    {
        ...
        hint: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cauta un loc inalt, cu vedere panoramica. Umbra sa cade spre vest la amiaza — acolo vei gasi urmatorul indiciu ascuns sub o piatra albastra.",
        bonus: {
            info: "Turnul Vechi dateaza din secolul al XIV-lea. A servit ca punct de observatie si adapost in vremuri de razboi. Pietrele sale pastreaza secrete pe care putini le cunosc.",
    ...
    },
    {
        ...
        hint: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. O poarta veche ascunde secretul. Numara treptele si inmulteste cu doi — acesta este codul tau secret.",
        bonus: {
            info: "Poarta Secreta a fost folosita de calugari pentru a intra in manastire fara a fi vazuti. Are o mecanica speciala ascunsa in mortar — apasa piatra cu simbolul crucii.",
            quiz: { question: "Cine folosea Poarta Secreta in mod traditional?", options: ["Soldatii", "Calugarii", "Comerciantii", "Nobilii"], correct: 1 }
        }
    },
    {
        num: 3,
        name: "Fantana Dorintelor",
        image: "images/step3.jpg",
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sunt in culpa qui officia deserunt mollit anim id est laborum. Sed perspiciatis unde omnis iste natus error sit voluptatem.",
        hint: "Lorem ipsum dolor sit amet. Apa curge dinspre nord. Urmareste sunetul izvorului prin padure pana gasesti piatra marcata cu X.",
        bonus: {
            info: "Fantana Dorintelor are o adancime de 18 metri. Se spune ca apa sa a vindecat boli. In fiecare an, pe 15 august, lumini misterioase apar la suprafata apei.",
    ...
    },
    {
        ...
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione.",
        hint: "Lorem ipsum dolor sit amet. O cruce veche de piatra pazeste taina. Priveste inspre rasarit la rasaritul soarelui — umbra crucii iti va arata directia corecta.",
        bonus: {
            info: "Crucea de Piatra a fost ridicata in memoria unui cavaler. Inscriptia de pe baza este scrisa in latina si contine un mesaj criptat.",
            quiz: { question: "In ce limba este scrisa inscriptia de pe Crucea de Piatra?", options: ["Romana", "Greaca", "Latina", "Slavona"], correct: 2 }
        }
    },
    {
        num: 5,
        name: "Podul Ferecatilor",
        image: "images/step5.jpg",
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis.",
        hint: "Lorem ipsum dolor sit amet. Sub pod, acolo unde pietrele sunt umede si mucegaite, vei gasi o caseta mica de metal. Codul tau se afla inauntru.",
        bonus: {
            info: "Podul Ferecatilor si-a primit numele de la mestesugar care l-a construit si care a fost feracat in pivnita pana la terminarea lucrarii. Lanturi originale se mai afla inca sub structura.",
    ...
    },
    {
        ...
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur.",
        hint: "Lorem ipsum dolor sit amet. Intra in padure pe poteca din dreapta. La al treilea copac bifurcat, uita-te sus — ceva luceste printre crengi.",
        bonus: {
            info: "Padurea Neagra contine copaci cu varsta de peste 400 de ani. Localnicii evita sa intre noaptea — se spune ca luminile care apar sunt spiritele celor care s-au pierdut in ea.",
            quiz: { question: "Ce varsta au unii copaci din Padurea Neagra?", options: ["200 de ani", "300 de ani", "400 de ani", "500 de ani"], correct: 2 }
        }
    },
    {
        num: 7,
        name: "Ruinele Cetatii",
        image: "images/step7.jpg",
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint.",
        hint: "Lorem ipsum dolor sit amet. Ruinele ascund mai mult decat pare. Intre al doilea si al treilea zid, o piatra albastra te asteapta — ridic-o cu atentie.",
        bonus: {
            info: "Cetatea a fost asediata de 3 ori in istoria sa si niciodata cucerita prin forta. A cazut din cauza unui tradat care a deschis portile din interior.",
            quiz: { question: "De cate ori a fost asediata cetatea?", options: ["O data", "De doua ori", "De trei ori", "De cinci ori"], correct: 2 }
        }
    },
    {
        num: 8,
        name: "Lacul Oglinzilor",
        image: "images/step8.jpg",
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur.",
        hint: "Lorem ipsum dolor sit amet. La malul lacului, acolo unde stuful este mai des, vei vedea o barca verde rasturnata. Sub ea se afla mesajul tau.",
        bonus: {
            info: "Lacul Oglinzilor are o suprafata perfecta in diminetile fara vant, reflectand muntii cu claritate fotografica. Pe fundul sau se afla ramasitele unui sat inundat in 1962.",
    ...
    {
        num: 9,
        name: "Pestera Echourilor",
        image: "images/step9.jpg",
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus.",
        hint: "Lorem ipsum dolor sit amet. Vorbeste la intrarea pesterii si asculta ecoul. De unde vine ultimul ecou, acolo cauta — in stanca, o nisa ascunsa.",
        bonus: {
            info: "Pestera Echourilor are o lungime totala de 2.3 km. Picturi rupestre au fost descoperite in 1978.",
            quiz: { question: "Cand au fost descoperite picturile rupestre din pestera?", options: ["1965", "1972", "1978", "1985"], correct: 2 }
        }
    },
    {
        num: 10,
        ...
        text: "Felicitari! Ai parcurs un drum lung si ai descoperit toate secretele acestui loc. Esti unul dintre putinii alesi care au ajuns pana aici. Scaneza codul QR de mai jos pentru a debloca etapa finala!",
        hint: "Lorem ipsum dolor sit amet. Esti atat de aproape! Ultimul loc este cel mai evident. Cauta acolo unde ai inceput totul — cercul se inchide.",
        bonus: {
            info: "Aceasta este a zecea etapa. Inca un pas si vei descoperi secretul final al Treasure Hunt CNNT.",
            quiz: { question: "Cate etape are aceasta aventura in total?", options: ["8", "9", "10", "11"], correct: 3 }
        }
    },
    {
        num: 11,
        ...
        text: "Ai reusit! Ai descoperit Locatia Finala a Treasure Hunt CNNT. Aceasta calatorie a testat cunoasterea ta, perseverenta si spiritul de aventura. Tine minte acest moment — esti un adevar Treasure Hunter!",
...
function buildRoadmap() {
    ...
    STEPS.forEach((step, idx) => {
        ...
        if (unlocked) {
            ...
            img.src = step.image;
            img.alt = step.name;
            img.onerror = function () { this.parentElement.innerHTML = `<div class="modal-img-placeholder">${isFinal ? "🏆" : "🗺️"}</div>`; };
...
function showStepModal(num) {
            ...
            <button class="modal-bonus-btn" id="openBonusScan" data-step="${num}">
                <div class="modal-bonus-btn-left">
                    ...
                    <div class="modal-bonus-btn-text">
                        <strong>${bonusDone ? "Revezi informatii bonus" : "Scanează pentru mai multe"}</strong>
                        <span>${bonusDone ? (quizScores[`step${num}`] !== undefined ? (quizScores[`step${num}`] ? "✓ Quiz completat" : "Quiz completat") : "Quiz disponibil") : "Info bonus + quiz despre acest loc"}</span>
                    </div>
                </div>
    ...
    document.getElementById("openBonusScan").addEventListener("click", () => {
...
function buildBonusResult(num) {
    ...
    const optsHTML = quiz.options.map((opt, i) => {
        const cls = done ? (i === quiz.correct ? "correct" : "wrong") : "";
        return `
            <button class="quiz-option ${cls}" data-index="${i}" ${done ? "disabled" : ""}>
    ...
    return `
        <div class="quiz-body">
            ...
            <div class="quiz-body" style="padding-top:0">
                ...
                <div class="quiz-feedback ${done ? (won ? "win" : "fail") : ""}" id="quizFeedback">
                    ${done ? (won ? "🎉 Răspuns corect! Bravo!" : "❌ Răspuns greșit. Încearcă data viitoare!") : ""}
                </div>
            </div>
        </div>
    `;
...
function attachQuizListeners(num) {
    if (quizScores[`step${num}`] !== undefined) return;
    ...
    document.querySelectorAll(".quiz-option").forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            fb.textContent = correct ? "🎉 Răspuns corect! Bravo!" : "❌ Răspuns greșit. Încearcă data viitoare!";
        });
    });
}
...
function onQrScanSuccess(decoded) {
    ...
    if (progress[stepKey]) {
        showFeedback(`✅ Etapa ${stepNum} deja deblocată!`, "feedback-info");
        return;
    }
